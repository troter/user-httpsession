package jp.troter.servlet.httpsession.example.memcached.resorces;
...
public class RootResourceTest extends JerseyTest {
    ...
    public RootResourceTest()throws Exception {
        super(new WebAppDescriptor.Builder("jp.troter.servlet.httpsession.example.memcached.resources")
